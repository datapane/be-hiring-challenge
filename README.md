...
To use the Command Line app, please navigate to the command_line directory and run the following command
python cli.py [OPTION] [COMMAND]
For example -> 1) python cli.py listalldatasets 2) python cli.py getdataset 4
